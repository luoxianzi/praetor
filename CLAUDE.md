...
2. **No config knobs.** The cut list in docs/DESIGN.md (config file, model picker, concurrency, retry knob, daemon, dashboards, auto-dispatch) is policy. Do not add these even if asked casually — point to CONTRIBUTING.md.
